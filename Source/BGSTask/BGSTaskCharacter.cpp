...
ABGSTaskCharacter::ABGSTaskCharacter()
{
	...
	GetCharacterMovement()->JumpZVelocity = 7500.f;
...
void ABGSTaskCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void ABGSTaskCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ABGSTaskCharacter::Move);
...
void ABGSTaskCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ABGSTaskCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
